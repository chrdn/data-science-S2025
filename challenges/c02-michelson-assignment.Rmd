...
-   Real data tends to "spike" a lot more steeply. Even the mean goes
    over the error range.

-   The real data collected tends to be "grouped" more. The simulated
    data has many points on both sides of the error bars that get "even
    out" to a mean that is contained within the error bars.
