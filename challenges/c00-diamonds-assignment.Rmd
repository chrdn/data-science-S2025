...
-   This adds information to the previous graph. We can see that the
    diamond that is an ideal cut generally has a higher price between
    two diamonds of the same carat. Often, the lowest price for a given
    carat is a "fair" or "good" cut diamond.
